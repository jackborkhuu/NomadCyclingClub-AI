...
Public Sub UpdateStageTimeCurrentSheetCore()
...
Private Function GetWorkbookTimeNumberFormat() As String
  GetWorkbookTimeNumberFormat = "hh:mm:ss"
End Function
...
Private Function TryParseTimeEntry(ByVal rawEntry As String, ByRef parsedValue As Double) As Boolean
  ...
  Dim wholeSeconds As Long, hundredths As Long
  ...
  Select Case Len(digitsOnly)
    Case 3
      wholeSeconds = CLng(Left$(digitsOnly, 1))
      hundredths = CLng(Right$(digitsOnly, 2))
    Case 4
      wholeSeconds = CLng(Left$(digitsOnly, 2))
      hundredths = CLng(Right$(digitsOnly, 2))
    Case 5
      wholeSeconds = CLng(Left$(digitsOnly, 3))
      hundredths = CLng(Right$(digitsOnly, 2))
    Case 6
      wholeSeconds = CLng(Left$(digitsOnly, 4))
      hundredths = CLng(Right$(digitsOnly, 2))
    Case 7
      wholeSeconds = CLng(Left$(digitsOnly, 5))
      hundredths = CLng(Right$(digitsOnly, 2))
    Case 8
      wholeSeconds = CLng(Left$(digitsOnly, 6))
      hundredths = CLng(Right$(digitsOnly, 2))
    Case Else
      Exit Function
  End Select

  parsedValue = (CDbl(wholeSeconds) + (CDbl(hundredths) / 100#)) / 86400#
  TryParseTimeEntry = True
End Function
